...
describe("Successfully Retrieve Assets", function(){
	var body;
	var res;
	var access_token;
	...
	before(function(done) {
		...
		function(error, r, b){
			...
			function(error, r, b){
				request.get({ url: config["baseUrl"] + "/api/v1/asset", 
					headers: {
						Authorization: access_token
					},
					json: true
	...
	it("has returned 5 results", function(done) {
...
describe("Successfully Retrieve Asset by invalid ID", function(){
	var body;
	var res;
	var access_token;
	...
	before(function(done) {
		...
		function(error, r, b){
			...
			function(error, r, b){
				request.get({ url: config["baseUrl"] + "/api/v1/asset/a", 
					headers: {
						Authorization: access_token
					},
					json: true
...
describe("Successfully Retrieve Asset by ID", function(){
	var body;
	var res;
	var access_token;
	...
	it("has returned 1 results", function(done) {
...
describe("Successfully Retrieve Asset by Keyword", function(){
	var body;
	var res;
	var access_token;
	...
	before(function(done) {
		...
		function(error, r, b){
			...
			function(error, r, b){
				request.get({ url: config["baseUrl"] + "/api/v1/asset/boat", 
					headers: {
						Authorization: access_token
					},
					json: true
